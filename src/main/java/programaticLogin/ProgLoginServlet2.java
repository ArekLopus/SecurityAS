...
@WebServlet("/Login2")
public class ProgLoginServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
	public ProgLoginServlet2() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<h2>Programatic Login Servlet (arka2 LM)</h2>");
		
		if(request.getUserPrincipal() == null) {
			request.login("darek", "darek");
		...
		if(request.getUserPrincipal() != null) {
			...
			pw.println("<br/>Developer?: "+request.isUserInRole("Developer"));
			pw.println("<br/><form>");
			pw.println("<form>");
